...
function gt_admin_notice_wp_version() {
    $message = __( 'GT Podcast Block Bindings requires WordPress 6.8 or higher.', 'gt-podcast-bb' );
    printf(
...
function gt_register_social_services( $services_data ) {
    ...
    $podcast_services = array(
        'applepod' => array(
            'name' => __( 'Apple Podcasts', 'gt-podcast-bb' ),
        ...
        'pocketcasts' => array(
            'name' => __( 'Pocket Casts', 'gt-podcast-bb' ),
        ...
        'podchaser' => array(
            'name' => __( 'Podchaser', 'gt-podcast-bb' ),
...
function gt_podcast_activate() {
    ...
    if ( version_compare( get_bloginfo( 'version' ), '6.8', '<' ) ) {
        ...
        wp_die( 
            esc_html__( 'GT Podcast Block Bindings requires WordPress 6.8 or higher.', 'gt-podcast-bb' ),
            esc_html__( 'Plugin Activation Error', 'gt-podcast-bb' ),
    ...
    if ( version_compare( PHP_VERSION, '7.4', '<' ) ) {
        deactivate_plugins( plugin_basename( __FILE__ ) );
        wp_die( 
            esc_html__( 'GT Podcast Block Bindings requires PHP 7.4 or higher.', 'gt-podcast-bb' ),
            esc_html__( 'Plugin Activation Error', 'gt-podcast-bb' ),
            array( 'back_link' => true )
        );
    }
